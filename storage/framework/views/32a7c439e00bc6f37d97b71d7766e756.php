...
<?php $__env->startSection('content'); ?>
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm p-6">
            <form method="POST" action="<?php echo e(route($prefix.'.categories.update', $category)); ?>" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="nom" type="text" name="nom" value="<?php echo e(old('nom', $category->nom)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('description', $category->description)); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MSI\Desktop\projet cote serveur\stock-management\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>