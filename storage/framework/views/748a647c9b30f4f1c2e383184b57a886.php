    ...
    <div class="bg-white rounded-xl shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
                ...
                <a href="<?php echo e(route($prefix.'.products.create')); ?>" 
            ...
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <select name="stock_filter" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    ...
                    <option value="faible" <?php echo e(request('stock_filter') === 'faible' ? 'selected' : ''); ?>>Stock faible</option>
                    <option value="rupture" <?php echo e(request('stock_filter') === 'rupture' ? 'selected' : ''); ?>>Rupture</option>
                </select>

                <div class="flex space-x-2">
                    <button type="submit" class="flex-1 px-4 py-2 bg-gray-800 hover:bg-gray-900 text-white rounded-lg">Filtrer</button>
                    <a href="<?php echo e(route($prefix.'.products.index')); ?>" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">Réinit.</a>
                </div>
            </form>
        </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <?php if($product->image): ?>
                                    <img src="<?php echo e(asset('storage/'.$product->image)); ?>" alt="<?php echo e($product->nom); ?>" class="w-12 h-12 rounded-lg object-cover">
                                <?php else: ?>
                            ...
                            <td class="px-4 py-3">
                                <div class="font-medium text-gray-800"><?php echo e($product->nom); ?></div>
                                <div class="text-xs text-gray-500 font-mono"><?php echo e($product->reference); ?></div>
                            </td>
                            <td class="px-4 py-3 text-sm text-gray-600"><?php echo e($product->category->nom ?? '-'); ?></td>
                            <td class="px-4 py-3">
                                <div class="text-sm font-semibold text-gray-800"><?php echo e(number_format($product->prix_vente, 2)); ?> DT</div>
                                <div class="text-xs text-gray-500">Achat : <?php echo e(number_format($product->prix_achat, 2)); ?> DT</div>
                            </td>
                            <td class="px-4 py-3 text-sm font-semibold"><?php echo e($product->quantite); ?></td>
                            <td class="px-4 py-3">
                                <?php $s = $product->statut_stock; ?>
                                <span class="px-2.5 py-1 text-xs font-semibold rounded-full bg-<?php echo e($s['color']); ?>-100 text-<?php echo e($s['color']); ?>-800">
                                    <?php echo e($s['label']); ?>
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end space-x-1">
                                    <a href="<?php echo e(route($prefix.'.products.show', $product)); ?>" 
                                    ...
                                    <a href="<?php echo e(route($prefix.'.products.edit', $product)); ?>" 
                                        class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg" title="Modifier">
                                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                        </svg>
                                    </a>
                                    <form method="POST" action="<?php echo e(route($prefix.'.products.destroy', $product)); ?>" 
        ...
        <?php if($products->hasPages()): ?>
            <div class="px-6 py-4 border-t border-gray-200"><?php echo e($products->links()); ?></div>
        <?php endif; ?>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MSI\Desktop\projet cote serveur\stock-management\resources\views/admin/products/index.blade.php ENDPATH**/ ?>