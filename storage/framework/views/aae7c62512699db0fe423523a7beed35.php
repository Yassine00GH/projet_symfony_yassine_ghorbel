        ...
        <aside id="sidebar" class="w-64 bg-gradient-to-b from-slate-900 to-slate-800 text-white flex-shrink-0 overflow-y-auto transition-all duration-300">
            ...
            <div class="px-6 py-5 border-b border-slate-700">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="font-bold text-sm"><?php echo e(config('app.name')); ?></h1>
                        <p class="text-xs text-slate-400"><?php echo e($user->role_label); ?></p>
                    </div>
                </div>
            </div>
            ...
            <nav class="px-3 py-4 space-y-1">
                <a href="<?php echo e(route($prefix.'.dashboard')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs($prefix.'.dashboard') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route($prefix.'.categories.index')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('*.categories.*') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?php echo e(route($prefix.'.products.index')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('*.products.*') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                    </svg>
                    Produits
                ...
                <?php if($isAdmin): ?>
                    ...
                    <a href="<?php echo e(route('admin.users.index')); ?>"
                       class="flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('admin.users.*') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200 flex-shrink-0">
                <div class="px-6 py-4 flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <h2 class="text-xl font-bold text-gray-800"><?php echo $__env->yieldContent('page-title', 'Tableau de bord'); ?></h2>
                    </div>
...
<?php /**PATH C:\Users\MSI\Desktop\projet cote serveur\stock-management\resources\views/layouts/app.blade.php ENDPATH**/ ?>