                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="adresse" name="adresse" rows="2"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"><?php echo e(old('adresse')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="role" name="role" required class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                            <option value="gestionnaire" <?php echo e(old('role')==='gestionnaire' ? 'selected' : ''); ?>>Gestionnaire</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MSI\Desktop\projet cote serveur\stock-management\resources\views/admin/users/create.blade.php ENDPATH**/ ?>